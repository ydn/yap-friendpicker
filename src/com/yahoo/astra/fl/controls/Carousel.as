package com.yahoo.astra.fl.controls
{
	...
	//--------------------------------------
		...
		{
			focusRectSkin:null, //required to enable proper focus highlight with keyboard navigation
			focusRectPadding:null, //required to enable proper focus highlight with keyboard navigation
